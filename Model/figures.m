...
load([main_folder 'full_data.mat'],'data','stat')
load([data_folder 'Model/stat_siginf.mat'],'stat_bst')
load([main_folder 'Model/model_eval.mat'],'model_eval')
...
for len_i = 1:n_len 
    ...
    for cond_i = 1:n_cond
        ...
        pd = fitdist(err_ori','Normal');
        text(-90,220-(40*cond_i),sprintf('sig = %0.1f',pd.sigma),'FontSize',11,'Color',colors(len_i,:))
        text(-90,205-(40*cond_i),sprintf('mu = %0.1f',pd.mu),'FontSize',11,'Color',colors(len_i,:))
